...
inputs = {
  ...
  dataset_viewers = [
    "serviceAccount:sa-f1v-data-analysis-dev@f1-visualizer-488201.iam.gserviceaccount.com",
    "serviceAccount:sa-f1v-data-analysis-uat@f1-visualizer-488201.iam.gserviceaccount.com",
    "serviceAccount:sa-f1v-data-analysis-prod@f1-visualizer-488201.iam.gserviceaccount.com",
