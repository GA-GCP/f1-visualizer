...
public class F1VisualizerSecurityConfig {
    ...
    /**
     * S7: the origin list used to be hardcoded here, in the STOMP endpoint, in the LB URL map and
     * in the gateway spec — four copies to keep in step, one of which shipped {@code
     * http://localhost:5173} in production images. It is now one property, set per environment.
     */
