...
All environments share a single GCP project (`f1v-example-project`), a single Artifact Registry repository (`f1v-repo`), and a shared BigQuery dataset (`f1_dataset`) — differentiated by environment labels and image tags.
