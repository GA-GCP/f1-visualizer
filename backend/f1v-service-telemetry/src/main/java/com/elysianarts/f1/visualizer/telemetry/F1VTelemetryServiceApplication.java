...
@ComponentScan(basePackages = {"com.elysianarts.f1.visualizer.telemetry", "com.elysianarts.f1.visualizer.telemetry.config", "com.elysianarts.f1.visualizer.commons"})
