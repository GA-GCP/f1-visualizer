...
dependency "iam" {
  ...
  mock_outputs = {
    sa_deploy_email = "sa-f1v-deploy-dev@f1-visualizer-488201.iam.gserviceaccount.com"
    sa_infra_email  = "sa-f1v-infra-dev@f1-visualizer-488201.iam.gserviceaccount.com"
  }
