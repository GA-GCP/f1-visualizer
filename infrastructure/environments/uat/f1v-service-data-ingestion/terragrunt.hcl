...
dependency "iam" {
  ...
  mock_outputs = {
    sa_data_ingestion_email = "sa-f1v-data-ingestion-uat@f1v-example-uat.iam.gserviceaccount.com"
  }
}
...
dependency "networking" {
  ...
  mock_outputs = {
    vpc_access_connector_id = "projects/f1v-example-uat/locations/us-central1/connectors/f1v-vpc-uat-conn-MOCK"
  }
}
...
inputs = {
  ...
  image_url    = get_env("TF_VAR_image_url", "us-central1-docker.pkg.dev/f1v-example-uat/f1v-repo/data-ingestion:latest")
