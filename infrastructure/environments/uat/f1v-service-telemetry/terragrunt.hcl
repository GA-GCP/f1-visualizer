...
dependency "iam" {
  ...
  mock_outputs = {
    sa_telemetry_email = "sa-f1v-telemetry-uat@f1v-example-uat.iam.gserviceaccount.com"
  }
}
...
inputs = {
  ...
  image_url    = "us-central1-docker.pkg.dev/f1v-example-uat/f1v-repo/telemetry:latest"
