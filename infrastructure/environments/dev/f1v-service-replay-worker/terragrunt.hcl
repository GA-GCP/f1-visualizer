...
dependency "networking" {
  ...
  mock_outputs = {
    ...
    subnetwork_name = "f1v-vpc-dev-subnet"
  }
...
inputs = {
  ...
  region                = "us-central1"
  service_name          = "f1v-service-replay-worker-dev"
  service_account_email = dependency.iam.outputs.sa_replay_worker_email
  image_url             = "us-central1-docker.pkg.dev/f1v-example-project/f1v-repo/replay-worker:latest-dev"
