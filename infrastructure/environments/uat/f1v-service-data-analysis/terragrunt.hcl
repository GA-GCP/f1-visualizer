...
dependency "iam" {
  ...
  mock_outputs = {
    sa_data_analysis_email = "sa-f1v-data-analysis-uat@f1v-example-project.iam.gserviceaccount.com"
...
inputs = {
  ...
  image_url    = "us-east1-docker.pkg.dev/f1v-example-project/f1v-repo/data-analysis:latest-uat"
