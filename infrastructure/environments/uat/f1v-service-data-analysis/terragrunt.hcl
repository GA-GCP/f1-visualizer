...
dependency "iam" {
  ...
  mock_outputs = {
    sa_data_analysis_email = "sa-f1v-data-analysis-uat@f1v-example-uat.iam.gserviceaccount.com"
  }
}
...
inputs = {
  ...
  image_url    = "us-central1-docker.pkg.dev/f1v-example-uat/f1v-repo/data-analysis:latest"
  ...
  env_vars = {
    ...
    "SPRING_CLOUD_GCP_FIRESTORE_PROJECT_ID"  = "f1v-example-uat"
