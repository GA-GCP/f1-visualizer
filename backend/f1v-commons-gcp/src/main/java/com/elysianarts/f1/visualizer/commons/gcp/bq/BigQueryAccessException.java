 ...
 *
 * <p>The replay repositories used to return an empty list or {@code null} on any
 * exception, which the replay engine could only interpret as "this session is
 * over". A BigQuery outage looked exactly like a finished simulation.</p>
 */
