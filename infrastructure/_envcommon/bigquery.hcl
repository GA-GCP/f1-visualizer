...
dependency "iam" {
  ...
  mock_outputs = {
    sa_data_ingestion_email = "sa-f1v-data-ingestion-${local.env.environment}@f1-visualizer-488201.iam.gserviceaccount.com"
    sa_data_analysis_email  = "sa-f1v-data-analysis-${local.env.environment}@f1-visualizer-488201.iam.gserviceaccount.com"
    sa_replay_worker_email  = "sa-f1v-replay-worker-${local.env.environment}@f1-visualizer-488201.iam.gserviceaccount.com"
  }
