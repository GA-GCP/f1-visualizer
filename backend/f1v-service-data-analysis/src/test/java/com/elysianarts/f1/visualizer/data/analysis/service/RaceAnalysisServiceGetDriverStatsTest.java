...
class RaceAnalysisServiceGetDriverStatsTest {
    ...
    void getDriverStats_CalculatesSpeedScore_FromAvgPosition(double avgPos, int expected)
    ...
    void getDriverStats_CalculatesConsistencyScore_FromPositionStdDev(double stdDev, int expected)
            throws InterruptedException {
        setupMockRowWithAllNulls();
    ...
    void getDriverStats_CalculatesAggressionScore_FromThrottlePct(double pct, int expected)
            throws InterruptedException {
        setupMockRowWithAllNulls();
    ...
    void getDriverStats_CalculatesTireMgmtScore_Correctly(double avgStintLen, int expected)
            throws InterruptedException {
        setupMockRowWithAllNulls();
    ...
    void getDriverStats_CalculatesExperienceScore_FromTotalRaces(long races, int expected)
            throws InterruptedException {
        setupMockRowWithAllNulls();
    ...
    /**
     * R5: the old behaviour returned placeholder 50/50/50 scores on failure — and the drivers list
     * cached those in Firestore as if they were real. A BigQuery outage now surfaces as an error
